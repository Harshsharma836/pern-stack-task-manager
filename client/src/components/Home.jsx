...
const Home = ({ isAuthenticated, tasks, setTasks, taskTitle }) => {
  ...
  const deleteTask = async (id) => {
    ...
    await axios
      .delete(`http://localhost:4000/api/task/delete/${id}`, {
  ...
  return (
    <div className="container my-4">
      ...
      <div className="row">
        {tasks && tasks.length > 0 ? (
          tasks.map((task) => (
            ...
            <div key={task.id} className="col-lg-3 col-md-4 col-sm-6">
              <Card style={{ marginBottom: "20px", minHeight: "400px" }}>
                <Card.Body className="d-flex justify-content-between flex-column ">
                  ...
                  >
                    <MdEdit
                      onClick={() => handleUpdateModalShow(task.id)}
                      className="fs-3 "
                    />
                    <MdDelete
                    ...
                    />
                    <FaEye
                      onClick={() => handleViewModalShow(task.id)}
                      className="fs-3 "
                    />
                  </Stack>
                </Card.Body>
      ...
      <ViewTaskModal
        ...
        id={viewTaskId}
      />
      <div className="footer mt-5 text-center fixed-bottom">
        <p>Build by Harsh Sharma</p>
        <p>Check GitHub: <a href="https://github.com/Harshsharma836">Harsh Sharma</a></p>
      </div>
    </div>
  );
};
